...
const GAME_DATA = {
  ...
  characters: {
    elias: { id:'elias', name:'Elias Crow', pronoun:'lui', emoji:'🏴‍☠️', avatar: 'assets/Foto_Elias.webp', desc:'Un audace pirata avventuriero alla ricerca di risposte e leggendari tesori perduti.' },
  ...
  items: {
    ...
    mappa_strappata:  { id:'mappa_strappata', name:'Frammento di Mappa',    nameCorrupt:'Carta strappata',  emoji:'🗺️', desc:'Un angolo di mappa che Pip ti ha dato. Mostra una X e la costa dell\'isola.', hint:'Questo frammento mostra un sentiero segreto. Cliccaci sopra per esaminarlo!' },
